    ...
    import(file: any, statusUpdater: any): any {
        return new Promise(function(accept, reject) {
            ...
            function complete(evt) {
                ...
                if (evt.target.getResponseHeader("Tuesmon-Info-Project-Is-Private")) {
                    response.headers = {
                        isPrivate: evt.target.getResponseHeader("Tuesmon-Info-Project-Is-Private") === "True",
                        memberships: parseInt(evt.target.getResponseHeader("Tuesmon-Info-Project-Memberships")),
                    };
                }
