...
- Contact with the project: if the projects have this module enabled Tuesmon users can contact them.
...
### Features
- Add Epics.
- Add the tribe button to link stories from manage.tuesmon.com with gigs in tribe.tuesmon.com.
...
## 1.9.1 Tuesmon Tribe (2016-01-05)

### Features
- [118n] Now tuesmon plugins can be translatable.
- New Tuesmon plugins system.
- Now superadmins can send notifications (live announcement) to the user (through tuesmon-events).

### Misc
- Statics folder hash to prevent cache problems when a new version is released.
- Implement websockets heartbeat messages system for tuesmon-events.
- Lots of small and not so small bugfixes.
...
### Features
- Make Tuesmon translatable (i18n support).
- i18n.
...
- Added Tuesmon Style Guide in support Pages to enhance open source design.
- Lots of small and not so small bugfixes.
...
- Now you can export and import projects between Tuesmon instances.
...
### Misc
- TUESMON loves Movember! The logo has a beautiful mustache this month.
- Lots of small and not so small bugfixes.
